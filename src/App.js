...
const initialCountriesList = [
  ...
  {
    id: '7ebb4e04-b124-417f-a69e-564a456d70f6',
    name: 'Thailand',
    imageUrl:
      'https://assets.ccbp.in/frontend/react-js/visit-countries-thailand-img.png',
    isVisited: false,
...
class App extends Component {
  ...
  onClickRemove = visitedCountry => {
    const {countries, visitedCountries} = this.state

    const updatedVisitedCountries = visitedCountries.filter(
      eachCountry => eachCountry.id !== visitedCountry.id,
    )

    const updatedCountries = countries.map(eachCountry =>
      eachCountry.id === visitedCountry.id
      ...
      <div className="app-container">
        ...
        <ul className="country-list">
          {countries.map(country => (
            <li key={country.id} className="country country-container">
              ...
              {country.isVisited ? (
                ...
                <button
                  type="button"
                  className="button"
                  onClick={() => this.onClickVisit(country)}
                >
                  Visit
                </button>
              )}
        ...
        <div>
          ...
          <ul className="countries-image-container">
            {visitedCountries.map(visitedCountry => (
              <li key={visitedCountry.id} className="country-image-list">
                <img
                ...
                <div className="name-remove-container">
                  ...
                  <button
                    ...
                    onClick={() => this.onClickRemove(visitedCountry)}
                  >
                    Remove
                  </button>
                </div>
